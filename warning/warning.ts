...
const restrictionMessages: { [key: string]: string } = {
...
export function registerRestrictions(blockName: string, blockRestrictions: any) {
    // @ts-ignore
...
export const disableUnapplicable = (workspace: Blockly.Workspace) => {
...
function validateRestriction(block: Blockly.Block, blocks: Blockly.Block[], restriction: any) {
    let reverse = false;
...
function validateConfiguration(block: Blockly.Block, restriction: any) {
...
function hasParentOfType(block: Blockly.Block, types: any) {
    let hasParent = false;
...
function getTopLevelParent(block: Blockly.Block): Blockly.Block | null|any  {
